...
class ProdutoRepository:
    ...
    def get_by_modelo (self, id_modelo):
        ...
        print("Iniciando busca do produto")
    ...
    def insert (self, params):
        ...
        print("Iniciando inserção do Produto")
        cur = self.con.estoque.cursor()
        cur.execute("insert into produto (id_modelo, unidade, preco, estoqueMin, id_categoria, status, venda, preco_venda, frequencia, limite_velocidade, velocidade_minima) value (%s, %s, %s, %s, %s, %s, %s, %s, %s, %s, %s)", (params[0], params[1], params[2], params[3], params[4], params[5], params[6], params[7], params[8], params[9],params[10]))

        id_produto = self.con.estoque.insert_id()
